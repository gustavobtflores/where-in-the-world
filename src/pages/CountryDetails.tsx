    ...
    <>
      {country ? (
        <Container className="h-[calc(100vh-80px)]">
          <Link
            className="py-2 px-6 text-sm dark:text-text-dark inline-flex items-center gap-2 bg-light-white dark:bg-elements-dark dark:hover:border-gray-500 border-transparent drop-shadow-lg rounded-md my-20 border-[1px] hover:border-blue-500 font-semibold transition-all duration-200"
            to="/"
          >
            <ArrowLeft size={20} />
            Back
          </Link>
          <div className="flex gap-20 items-center dark:text-text-dark">
            <img
              className="max-w-lg"
              src={country.flag}
            ...
            <div className="w-full">
              <h1 className="text-[32px] font-bold text-text-light mb-8 dark:text-text-dark">
                {country.name.common}
              </h1>
